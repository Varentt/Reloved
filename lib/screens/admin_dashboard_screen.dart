    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<ProductModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (products.isEmpty) {
            return const Center(
              child: Text('Tidak ada produk yang perlu diverifikasi'),
            );
          }
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: () => productService.updateProductStatus(
                              p.id,
                              'Reject',
                            ),
                            child: const Text(
...
class _KelolapenggunaPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const Center(child: Text('Kelola Pengguna Page'));
}
...
class _TotalProdukPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const Center(child: Text('Total Produk Page'));
}
...
class _TotalTransaksiPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const Center(child: Text('Total Transaksi Page'));
}
...
class _NotifikasiPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const Center(child: Text('Notifikasi Admin Page'));
}
