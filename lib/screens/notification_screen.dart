...
class _NotificationScreenState extends State<NotificationScreen> {
  final List<Map<String, dynamic>> _notifs = [
    ...
    },
    {
      ...
      'body':
          'Kamera Analog Canon kamu dipesan oleh Budi S. Segera kirim barang.',
      'time': '1 hari lalu',
      'read': true,
    },
    {
      ...
      'body':
          'Sepatu Vans Second kamu telah diverifikasi dan kini tampil di marketplace.',
      'time': '2 hari lalu',
      'read': true,
    },
    {
    ...
    },
    {
      ...
      'body':
          'Roti Sobek yang kamu jual akan expired dalam 2 hari. Turunkan harga agar cepat terjual.',
      'time': '3 hari lalu',
      'read': true,
    },
  ];
