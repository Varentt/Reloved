...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  // Mapping status penjualan ke index flow
  int get _statusIndex {
    if (widget.type == 'penjualan') {
      switch (_currentStatus) {
        case 'Perlu Dikirim':
          return 1; // posisi Dikemas (belum dikirim)
        case 'Dikemas':
          return 1;
        case 'Dikirim':
          return 2;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ── Progress Status (pembelian & penjualan) ──
                    Container(
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        color: Colors.white,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          if (isPembelian) ...[
                            // Pembeli lihat: lokasi penjual & alamat pengiriman ke dirinya
                            _DetailRow(
                            ...
                            _DetailRow(
                              ...
                              value: 'Jl. Contoh No. 123, Jember',
                            ),
                          ] else ...[
                            // Penjual lihat: alamat pembeli (tujuan kirim)
                            _DetailRow(
                            ...
                            _DetailRow(
                              icon: Icons.home_outlined,
                              label: 'Alamat Tujuan',
                              value: 'Jl. Pembeli No. 456, Jember',
                            ),
                          ],
                        ],
                      ),
                        ...
                        children: [
                          const Text('Ringkasan Pembayaran',
                              style: TextStyle(
                                  ...
                                  color: _textPrimary)),
                          const SizedBox(height: 12),
                          _PayRow(label: 'Harga Produk', value: o['price']!),
                          const SizedBox(height: 6),
                          _PayRow(
                              label: 'Biaya Pengiriman', value: 'Rp10.000'),
                          const Padding(
                    ...
                    // ── Tombol Pesanan Diterima (pembeli, status Dikirim) ──
                    ...
                    // ── Tombol Kirim Barang (penjual, status Perlu Dikirim) ──
